package com.zahideaksak.marvel.presentation.ui.marvel_character_detail.viewmodel
...
import com.zahideaksak.marvel.data.remote.model.comics.toComics
import com.zahideaksak.marvel.data.remote.model.dto.toMarvelCharacter
...
class MarvelCharacterDetailViewModel @Inject constructor(
    ...
    init {
        viewModelScope.launch {
            getDataMarvelCharacterByIdAndComics()
        }
    }

    suspend fun getDataMarvelCharacterByIdAndComics() {
        characterId?.let { id ->
            getMarvelCharacterByIdAndComics(id)
        }
    }
