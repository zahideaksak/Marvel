package com.zahideaksak.marvel.presentation.ui.marvel_character_detail
...
import coil.load
import com.zahideaksak.marvel.databinding.FragmentMarvelCharacterDetailBinding
import com.zahideaksak.marvel.domain.model.Comics
import com.zahideaksak.marvel.presentation.bindingadapter.BindingFragment
import com.zahideaksak.marvel.presentation.ui.activities.MainActivity
import com.zahideaksak.marvel.presentation.ui.marvel_character_detail.adapter.ComicsAdapter
import com.zahideaksak.marvel.presentation.ui.marvel_character_detail.state.MarvelDetailState
import com.zahideaksak.marvel.presentation.ui.marvel_character_detail.viewmodel.MarvelCharacterDetailViewModel
    ...
    private fun showError(state: MarvelDetailState) {
        if (state.error.isNotBlank()) {
            ...
            binding.viewError.retry.setOnClickListener {
                lifecycleScope.launch {
                    marvelCharacterDetailViewModel.getDataMarvelCharacterByIdAndComics()
                }
            }
        }
    }
